...
template <size_t Nc>
struct DeviceGaugeFieldType<4, Nc, GaugeFieldKind::JTBC> {
  using type = deviceJTBCGaugeField<4, Nc>;
};

template <size_t Nc>
struct DeviceGaugeFieldType<3, Nc, GaugeFieldKind::JTBC> {
  using type = deviceJTBCGaugeField3D<3, Nc>;
};

template <size_t Nc>
struct DeviceGaugeFieldType<2, Nc, GaugeFieldKind::JTBC> {

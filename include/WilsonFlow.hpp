...
#pragma unroll
  ...
  KOKKOS_INLINE_FUNCTION void stepW1(indexType i0, indexType i1, indexType i2,
    ...
    SUN<Nc> Z0_SUN = conj(tmp_staple.field(i0, i1, i2, i3, mu)) *
                     conj(field.field(i0, i1, i2, i3, mu));
    SUNAdj<Nc> Z0 = traceT(Z0_SUN) * (-Nc / params.beta * params.eps);
  ...
  KOKKOS_INLINE_FUNCTION void stepW2(indexType i0, indexType i1, indexType i2,
                                     indexType i3, index_t mu) const {
    SUN<Nc> Z1_SUN = conj(tmp_staple.field(i0, i1, i2, i3, mu)) *
                     conj(field.field(i0, i1, i2, i3, mu));
    SUNAdj<Nc> Z1 = traceT(Z1_SUN) * (-Nc / params.beta * params.eps);
  ...
  KOKKOS_INLINE_FUNCTION void stepV(indexType i0, indexType i1, indexType i2,
                                    indexType i3, index_t mu) const {
    SUN<Nc> Z2_SUN = conj(tmp_staple.field(i0, i1, i2, i3, mu)) *
                     conj(field.field(i0, i1, i2, i3, mu));
    SUNAdj<Nc> Z2 = traceT(Z2_SUN) * (-Nc / params.beta * params.eps);

...
#pragma unroll
  ...
  KOKKOS_INLINE_FUNCTION void stepW1(indexType i0, indexType i1, indexType i2,
    ...
    Z0 = make_antiherm(Z0) * params.eps;
    tmp_Z(i0, i1, i2, i3, mu) = Z0;
    SUNAdj<Nc> tmp = traceT(Z0 * static_cast<real_t>(1.0 / 4.0));
    field(i0, i1, i2, i3, mu) = expoSUN(-1.0*tmp) * field(i0, i1, i2, i3, mu);

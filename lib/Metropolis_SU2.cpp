...
namespace klft {
  ...
  void Metropolis_SU2_4D(const size_t &LX, const size_t &LY, const size_t &LZ, const size_t &LT, 
    ...
    Kokkos::initialize();
    {
      using GaugeGroup = SU2<T>;
      using GaugeFieldType = GaugeField<T,GaugeGroup,4,2>;
  ...
  void Metropolis_SU2_3D(const size_t &LX, const size_t &LY, const size_t &LT, 
    ...
    {
      using GaugeGroup = SU2<T>;
      using GaugeFieldType = GaugeField<T,GaugeGroup,3,2>;
      using RNG = Kokkos::Random_XorShift1024_Pool<Kokkos::DefaultExecutionSpace>;
      RNG rng = RNG(seed);
  ...
  void Metropolis_SU2_2D(const size_t &LX, const size_t &LT, 
    ...
    {
      using GaugeGroup = SU2<T>;
      using GaugeFieldType = GaugeField<T,GaugeGroup,2,2>;
      using RNG = Kokkos::Random_XorShift1024_Pool<Kokkos::DefaultExecutionSpace>;
      RNG rng = RNG(seed);
